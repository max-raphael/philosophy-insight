        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="mt-12 pt-8 border-t border-[var(--border-primary)] flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4 text-xs text-[var(--text-muted)] font-ui">
              <span>Texts from public domain works.</span>
              <span className="hidden sm:inline">·</span>
              <Link to="/privacy" className="hover:text-[var(--accent-primary)] transition-colors">
                Privacy
              </Link>
              <span className="hidden sm:inline">·</span>
              <Link to="/feedback" className="hover:text-[var(--accent-primary)] transition-colors">
                Feedback
              </Link>
            </div>
